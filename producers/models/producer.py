...
class Producer:
    ...
    def __init__(
        ...
        self.producer = AvroProducer(self.broker_properties, schema_registry=CachedSchemaRegistryClient("http://localhost:8081"))
    ...
    def create_topic(self):
        ...
        if not topic_exists:
            ...
            logger.info(f"{self.topic_name} topic already created")
